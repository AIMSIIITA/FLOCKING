...
pygame.display.set_caption("FLOCKING Visualization")
green = (0, 0, 255)
red = (255, 0, 0)
...
class Particle():
    ...
    def set_velocity(self, gbest_position, gbest_value):
        ...
        vel_social = c2 * r2 * (gbest_position - self.position)#team best distance.
...
def main():
    particle_list = [Particle() for _ in range(5)]
    run = False
